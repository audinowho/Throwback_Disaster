...
function hauntedzone_entrance.Buneary_Action(chara, activator)
  ...
  UI:ResetSpeaker()
  UI:BeginChoiceMenu(STRINGS:Format(STRINGS.MapStrings['Narration_0']),
	{STRINGS:Format(STRINGS.MapStrings['ActionChoice_0']),
	STRINGS:Format(STRINGS.MapStrings['ActionChoice_1']),
	STRINGS:Format(STRINGS.MapStrings['ActionChoice_2'])}, 1, 1)
  UI:WaitForChoice()
  ...
  UI:ResetSpeaker()
  if result == 3 then
    UI:WaitShowDialogue(STRINGS:Format(STRINGS.MapStrings['Narration_1B']))
  else
	UI:WaitShowDialogue(STRINGS:Format(STRINGS.MapStrings['Narration_1A']))
  end
  UI:WaitShowDialogue(STRINGS:Format(STRINGS.MapStrings['Narration_2']))
...
function hauntedzone_entrance.Chespin_Action(chara, activator)
  ...
  UI:WaitShowDialogue(STRINGS:Format(STRINGS.MapStrings['Chespin_0']))
end
...
function hauntedzone_entrance.Litwick_Action(chara, activator)
  ...
  if SV.sidequest_buneary < 3 then
    UI:WaitShowDialogue(STRINGS:Format(STRINGS.MapStrings['Litwick_0']))
  else
    UI:SetSpeakerEmotion("Surprised")
	UI:WaitShowDialogue(STRINGS:Format(STRINGS.MapStrings['Litwick_1']))
  end
end
