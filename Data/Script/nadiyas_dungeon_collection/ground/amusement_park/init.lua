...
function amusement_park.Enter(map)
  ...
  if SV.global_quest.StoryProgression == 7 then
	...
	if SV.global_quest.BossWin == true then
	  ...
	  GAME:WaitFrames(30)
	  UI:WaitShowDialogue(STRINGS:Format(STRINGS.MapStrings['Message_3']))
	else
	  GROUND:CharSetEmote(player, "sweating", 1)
	  SOUND:PlayBattleSE("EVT_Emote_Sweating")
	  GAME:WaitFrames(30)
	  UI:WaitShowDialogue(STRINGS:Format(STRINGS.MapStrings['Message_2']))
	...
	UI:SetSpeaker(poww)
	UI:BeginChoiceMenu(STRINGS:Format(STRINGS.MapStrings['Powwene_1']),
	{STRINGS:Format(STRINGS.MapStrings['Answer_A_3']),
	STRINGS:Format(STRINGS.MapStrings['Answer_B_3'])}, 1, 2)
	UI:WaitForChoice()
	...
	UI:WaitShowDialogue(STRINGS:Format(STRINGS.MapStrings['Powwene_5']))
	UI:WaitShowDialogue(STRINGS:Format(STRINGS.MapStrings['Powwene_6']))
	UI:WaitShowDialogue(STRINGS:Format(STRINGS.MapStrings['Powwene_7']))
	UI:WaitShowDialogue(STRINGS:Format(STRINGS.MapStrings['Powwene_8']))
	GROUND:CharAnimateTurn(poww, Direction.Left, 4, true)
	GROUND:MoveInDirection(poww, Direction.Left, 30, false, 1)
	UI:WaitShowDialogue(STRINGS:Format(STRINGS.MapStrings['Powwene_9']))
	GROUND:CharAnimateTurn(poww, Direction.Up, 4, false)
	UI:WaitShowDialogue(STRINGS:Format(STRINGS.MapStrings['Powwene_10']))
	UI:WaitShowDialogue(STRINGS:Format(STRINGS.MapStrings['Powwene_11']))
  ...
  if SV.global_quest.StoryProgression == 3 then
    ...
    UI:SetSpeaker(STRINGS:Format("\\uE040"), true, "", -1, "", RogueEssence.Data.Gender.Unknown)
    UI:WaitShowDialogue(STRINGS:Format(STRINGS.MapStrings['Vitaro_0']))
	UI:WaitShowDialogue(STRINGS:Format(STRINGS.MapStrings['Vitaro_1']))
    GAME:FadeIn(20)
	UI:SetSpeaker(vitaro)
	UI:SetSpeakerEmotion("Happy")
	UI:BeginChoiceMenu(STRINGS:Format(STRINGS.MapStrings['Vitaro_2']),
	{STRINGS:Format(STRINGS.MapStrings['Answer_A_1']),
	STRINGS:Format(STRINGS.MapStrings['Answer_B_1'])}, 1, 2)
	GROUND:CharAnimateTurn(player, Direction.Right, 4, true)
	UI:WaitForChoice()
	result = UI:ChoiceResult()
	if result == 2 then
	  UI:SetSpeakerEmotion("Surprised")
	  UI:WaitShowDialogue(STRINGS:Format(STRINGS.MapStrings['Vitaro_2_1']))
	end
	UI:SetSpeakerEmotion("Worried")
	UI:BeginChoiceMenu(STRINGS:Format(STRINGS.MapStrings['Vitaro_3']),
	{STRINGS:Format(STRINGS.MapStrings['Answer_A_2']),
	STRINGS:Format(STRINGS.MapStrings['Answer_B_2'])}, 1, 2)
	UI:WaitForChoice()
	result = UI:ChoiceResult()
	if result == 1 then
	  UI:WaitShowDialogue(STRINGS:Format(STRINGS.MapStrings['Vitaro_4_1']))
	  UI:SetSpeakerEmotion("Sad")
	  UI:WaitShowDialogue(STRINGS:Format(STRINGS.MapStrings['Vitaro_4_2']))
	  UI:WaitShowDialogue(STRINGS:Format(STRINGS.MapStrings['Vitaro_4_3']))
	else
	  UI:WaitShowDialogue(STRINGS:Format(STRINGS.MapStrings['Vitaro_5_1']))
	  UI:WaitShowDialogue(STRINGS:Format(STRINGS.MapStrings['Vitaro_5_2']))
	end
	UI:SetSpeakerEmotion("Normal")
	UI:WaitShowDialogue(STRINGS:Format(STRINGS.MapStrings['Vitaro_6']))
	UI:WaitShowDialogue(STRINGS:Format(STRINGS.MapStrings['Vitaro_7']))
  ...
  if SV.global_quest.StoryProgression == 28 then
	...
	UI:WaitShowTimedDialogue(STRINGS:Format(STRINGS.MapStrings['Abigail_0']),150)
	GAME:WaitFrames(60)
	...
	UI:WaitShowDialogue(STRINGS:Format(STRINGS.MapStrings['Abigail_1']))
	UI:SetSpeakerEmotion("Surprised")
	UI:WaitShowDialogue(STRINGS:Format(STRINGS.MapStrings['Abigail_2']))
	GROUND:CharAnimateTurn(missy, Direction.Left, 4, false)
	GROUND:CharAnimateTurn(abigail, Direction.Right, 4, true)
	UI:SetSpeaker(missy)
	UI:SetSpeakerEmotion("Determined")
	UI:WaitShowDialogue(STRINGS:Format(STRINGS.MapStrings['Missy_0']))
	UI:SetSpeaker(abigail)
	UI:SetSpeakerEmotion("Determined")
	UI:WaitShowDialogue(STRINGS:Format(STRINGS.MapStrings['Abigail_3']))
	UI:SetSpeaker(missy)
	UI:SetSpeakerEmotion("Angry")
	UI:WaitShowDialogue(STRINGS:Format(STRINGS.MapStrings['Missy_1']))
	...
	UI:SetSpeakerEmotion("Worried")
	UI:WaitShowDialogue(STRINGS:Format(STRINGS.MapStrings['Gapori_11']))
	abigail.Data.Nickname = "Abigail"
	UI:SetSpeaker(abigail)
	UI:WaitShowDialogue(STRINGS:Format(STRINGS.MapStrings['Abigail_4']))
	UI:SetSpeakerEmotion("Worried")
	UI:WaitShowDialogue(STRINGS:Format(STRINGS.MapStrings['Abigail_5']))
	UI:SetSpeaker(gapori)
	UI:SetSpeakerEmotion("Worried")
	UI:WaitShowDialogue(STRINGS:Format(STRINGS.MapStrings['Gapori_12']))
	UI:SetSpeaker(abigail)
	UI:SetSpeakerEmotion("Worried")
	UI:WaitShowDialogue(STRINGS:Format(STRINGS.MapStrings['Abigail_6']))
	UI:SetSpeaker(missy)
	UI:SetSpeakerEmotion("Shouting")
	UI:WaitShowDialogue(STRINGS:Format(STRINGS.MapStrings['Missy_2']))
	UI:SetSpeakerEmotion("Surprised")
	UI:WaitShowDialogue(STRINGS:Format(STRINGS.MapStrings['Missy_3']))
	UI:SetSpeaker(gapori)
	UI:SetSpeakerEmotion("Sad")
	UI:WaitShowDialogue(STRINGS:Format(STRINGS.MapStrings['Gapori_3']))
	missy.Data.Nickname = "Missy"
	UI:SetSpeaker(missy)
	UI:WaitShowDialogue(STRINGS:Format(STRINGS.MapStrings['Missy_4']))
...
function amusement_park.Sign_Crafting_Action(obj, activator)
  ...
  UI:ResetSpeaker()
  UI:WaitShowDialogue(STRINGS:Format(STRINGS.MapStrings['Sign_Crafting']))
end

function amusement_park.Sign_Activities_Action(obj, activator)
  DEBUG.EnableDbgCoro() --Enable debugging this coroutine
  UI:ResetSpeaker()
  UI:WaitShowDialogue(STRINGS:Format(STRINGS.MapStrings['Sign_Activities']))
end

function amusement_park.Sign_Museum_Action(obj, activator)
  DEBUG.EnableDbgCoro() --Enable debugging this coroutine
  UI:ResetSpeaker()
  UI:WaitShowDialogue(STRINGS:Format(STRINGS.MapStrings['Sign_Museum']))
end

function amusement_park.Sign_Shop_Action(obj, activator)
  DEBUG.EnableDbgCoro() --Enable debugging this coroutine
  UI:ResetSpeaker()
  UI:WaitShowDialogue(STRINGS:Format(STRINGS.MapStrings['Sign_Shop']))
end

function amusement_park.Sign_Box_Action(obj, activator)
  DEBUG.EnableDbgCoro() --Enable debugging this coroutine
  UI:ResetSpeaker()
  UI:WaitShowDialogue(STRINGS:Format(STRINGS.MapStrings['Sign_Box']))
end
...
function amusement_park.Indeedee_Action(chara, activator)
  ...
  UI:SetSpeaker(chara)
  UI:SetSpeakerEmotion("Surprised")
  UI:WaitShowDialogue(STRINGS:Format(STRINGS.MapStrings['Indeedee_0']))
  UI:SetSpeakerEmotion("Normal")
  UI:WaitShowDialogue(STRINGS:Format(STRINGS.MapStrings['Indeedee_1']))
  UI:SetSpeakerEmotion("Happy")
  UI:WaitShowDialogue(STRINGS:Format(STRINGS.MapStrings['Indeedee_2']))
  UI:WaitShowDialogue(STRINGS:Format(STRINGS.MapStrings['Indeedee_3']))
  UI:SetSpeakerEmotion("Normal")
  UI:WaitShowDialogue(STRINGS:Format(STRINGS.MapStrings['Indeedee_4']))
  UI:SetSpeakerEmotion("Inspired")
  UI:WaitShowDialogue(STRINGS:Format(STRINGS.MapStrings['Indeedee_5']))
end
...
function amusement_park.ARaichu_Action(chara, activator)
  ...
  UI:SetSpeaker(chara)
  UI:SetSpeakerEmotion("Happy")
  UI:WaitShowDialogue(STRINGS:Format(STRINGS.MapStrings['ARaichu_0']))
  UI:SetSpeakerEmotion("Worried")
  UI:WaitShowDialogue(STRINGS:Format(STRINGS.MapStrings['ARaichu_1']))
  UI:SetSpeaker(gapori)
  UI:SetSpeakerEmotion("Worried")
  UI:WaitShowDialogue(STRINGS:Format(STRINGS.MapStrings['Gapori_4']))
  UI:SetSpeaker(chara)
  UI:SetSpeakerEmotion("Determined")
  UI:WaitShowDialogue(STRINGS:Format(STRINGS.MapStrings['ARaichu_2']))
  UI:SetSpeaker(gapori)
  UI:SetSpeakerEmotion("Determined")
  UI:WaitShowDialogue(STRINGS:Format(STRINGS.MapStrings['Gapori_5']))
  UI:SetSpeaker(chara)
  UI:SetSpeakerEmotion("Angry")
  UI:WaitShowDialogue(STRINGS:Format(STRINGS.MapStrings['ARaichu_3']))
  UI:SetSpeaker(gapori)
  UI:SetSpeakerEmotion("Determined")
  UI:WaitShowDialogue(STRINGS:Format(STRINGS.MapStrings['Gapori_6']))
  UI:SetSpeaker(chara)
  UI:SetSpeakerEmotion("Angry")
  UI:WaitShowDialogue(STRINGS:Format(STRINGS.MapStrings['ARaichu_4']))
  UI:ResetSpeaker()
  UI:WaitShowDialogue(STRINGS:Format(STRINGS.MapStrings['Message_6']))
end
...
function amusement_park.Hoppip_Action(chara, activator)
  ...
  if quest_ > 3 then
    UI:SetSpeakerEmotion("Happy")
	UI:WaitShowDialogue(STRINGS:Format(STRINGS.MapStrings['Hoppip_3']))
  elseif quest_ == 1 then
    UI:WaitShowDialogue(STRINGS:Format(STRINGS.MapStrings['Hoppip_1']))
	UI:WaitShowDialogue(STRINGS:Format(STRINGS.MapStrings['Hoppip_2']))
	GAME:FadeOut(false, 20)
	quest_ = 2
	GROUND:Hide("Hoppip")
	GAME:FadeIn(20)
  else
    UI:WaitShowDialogue(STRINGS:Format(STRINGS.MapStrings['Hoppip_0']))
  end
...
function amusement_park.Hattrem_Action(chara, activator)
  ...
  if SV.global_quest.StoryProgression > 25 then
    if quest_ == 0 then
	  UI:WaitShowDialogue(STRINGS:Format(STRINGS.MapStrings['Hattrem_4']))
	  UI:SetSpeakerEmotion("Worried")
	  UI:WaitShowDialogue(STRINGS:Format(STRINGS.MapStrings['Hattrem_5']))
	  UI:SetSpeakerEmotion("Normal")
	  UI:WaitShowDialogue(STRINGS:Format(STRINGS.MapStrings['Hattrem_6']))
	  UI:WaitShowDialogue(STRINGS:Format(STRINGS.MapStrings['Hattrem_7']))
	  quest_ = 1
	  COMMONEX.SidequestAccept(questname)
	else
	  if quest_ == 3 then
	    UI:SetSpeakerEmotion("Happy")
		UI:WaitShowDialogue(STRINGS:Format(STRINGS.MapStrings['Hattrem_10']))
	  elseif quest_ == 2 then
	    UI:SetSpeakerEmotion("Joyous")
	    UI:WaitShowDialogue(STRINGS:Format(STRINGS.MapStrings['Hattrem_8']))
	    UI:WaitShowDialogue(STRINGS:Format(STRINGS.MapStrings['Hattrem_9']))
    ...
    UI:WaitShowDialogue(STRINGS:Format(STRINGS.MapStrings['Hattrem_0']))
	UI:SetSpeakerEmotion("Worried")
    UI:WaitShowDialogue(STRINGS:Format(STRINGS.MapStrings['Hattrem_1']))
	UI:SetSpeakerEmotion("Shouting")
    UI:WaitShowDialogue(STRINGS:Format(STRINGS.MapStrings['Hattrem_2']))
	UI:SetSpeakerEmotion("Sad")
    UI:WaitShowDialogue(STRINGS:Format(STRINGS.MapStrings['Hattrem_3']))
  end
...
function amusement_park.Powwene_Action(chara, activator)
  GROUND:CharTurnToChar(chara,CH('PLAYER'))
  UI:SetSpeaker(chara)
  UI:WaitShowDialogue(STRINGS:Format(STRINGS.MapStrings['Powwene_12']))
end

function amusement_park.Mimikyu_Action(chara, activator)
  UI:ResetSpeaker()
  UI:WaitShowDialogue(STRINGS:Format(STRINGS.MapStrings['Message_7']))
end

function amusement_park.Beldum_Action(chara, activator)
  GROUND:CharTurnToChar(chara,CH('PLAYER'))
  UI:SetSpeaker(chara)
  UI:WaitShowDialogue(STRINGS:Format(STRINGS.MapStrings['Beldum_0']))
end
...
function amusement_park.Sandslash_Action(chara, activator)
  ...
  if SV.global_quest.StoryProgression > 7 then
    UI:SetSpeakerEmotion("Determined")
    UI:WaitShowDialogue(STRINGS:Format(STRINGS.MapStrings['Sandslash_2']))
  else
    UI:SetSpeakerEmotion("Angry")
    UI:WaitShowDialogue(STRINGS:Format(STRINGS.MapStrings['Sandslash_0']))
	UI:SetSpeakerEmotion("Surprised")
    UI:WaitShowDialogue(STRINGS:Format(STRINGS.MapStrings['Sandslash_1']))
  end
end
...
function amusement_park.Slakoth_Action(chara, activator)
  ...
  if SV.global_quest.StoryProgression > 23 then
    local gapori = CH("Gapori")
    UI:WaitShowDialogue(STRINGS:Format(STRINGS.MapStrings['Slakoth_1']))
	UI:SetSpeaker(gapori)
	UI:SetSpeakerEmotion("Worried")
    UI:WaitShowDialogue(STRINGS:Format(STRINGS.MapStrings['Gapori_10']))
	UI:SetSpeaker(chara)
	UI:WaitShowDialogue(STRINGS:Format(STRINGS.MapStrings['Slakoth_2']))
  else
    UI:WaitShowDialogue(STRINGS:Format(STRINGS.MapStrings['Slakoth_0']))
  end
end
...
function amusement_park.Teddiursa_Action(chara, activator)
  ...
  if SV.sidequest.quest03 > 3 then
	...
	UI:WaitShowDialogue(STRINGS:Format(STRINGS.MapStrings['Teddiursa_1']))
  else
    UI:SetSpeakerEmotion("Happy")
    UI:WaitShowDialogue(STRINGS:Format(STRINGS.MapStrings['Teddiursa_0']))
  end
end
...
function amusement_park.Torchic_Action(chara, activator)
  ...
  if quest_ > 3 then
    UI:SetSpeakerEmotion("Happy")
	if quest_ == 4 then
	  UI:WaitShowDialogue(STRINGS:Format(STRINGS.MapStrings['Torchic_8']))
	  UI:WaitShowDialogue(STRINGS:Format(STRINGS.MapStrings['Torchic_9']))
	  COMMON.GiftItemFull(CH('PLAYER'), RogueEssence.Dungeon.InvItem("evo_fire_stone"),true,false)
	  COMMONEX.PointIncrease(3)
	  quest_ = 5
	  COMMONEX.SidequestCleared(questname)
	else
	  UI:WaitShowDialogue(STRINGS:Format(STRINGS.MapStrings['Torchic_10']))
	end
  elseif SV.global_quest.StoryProgression > 11 then
    if quest_ == 0 then
	  UI:SetSpeakerEmotion("Shouting")
	  UI:WaitShowDialogue(STRINGS:Format(STRINGS.MapStrings['Torchic_1']))
	  UI:SetSpeakerEmotion("Teary-Eyed")
	  UI:WaitShowDialogue(STRINGS:Format(STRINGS.MapStrings['Torchic_2']))
	  UI:WaitShowDialogue(STRINGS:Format(STRINGS.MapStrings['Torchic_3']))
	  UI:WaitShowDialogue(STRINGS:Format(STRINGS.MapStrings['Torchic_4']))
	  UI:SetSpeakerEmotion("Shouting")
	  UI:WaitShowDialogue(STRINGS:Format(STRINGS.MapStrings['Torchic_5']))
	  quest_ = 1
	  COMMONEX.SidequestAccept(questname)
	else
	  UI:SetSpeakerEmotion("Crying")
	  UI:WaitShowDialogue(STRINGS:Format(STRINGS.MapStrings['Torchic_6']))
	  UI:SetSpeakerEmotion("Surprised")
	  UI:WaitShowDialogue(STRINGS:Format(STRINGS.MapStrings['Torchic_7'], SV.playername))
	end
  else
    UI:WaitShowDialogue(STRINGS:Format(STRINGS.MapStrings['Torchic_0']))
  end
  SV.sidequest.quest03 = quest_
end
...
function amusement_park.Flaaffy_Action(chara, activator)
  GROUND:CharTurnToChar(chara,CH('PLAYER'))
  UI:SetSpeaker(chara)
  UI:WaitShowDialogue(STRINGS:Format(STRINGS.MapStrings['Flaaffy_0']))
  UI:WaitShowDialogue(STRINGS:Format(STRINGS.MapStrings['Flaaffy_1']))
  UI:SetSpeakerEmotion("Determined")
  UI:WaitShowDialogue(STRINGS:Format(STRINGS.MapStrings['Flaaffy_2']))
end
...
function amusement_park.Girafarig_Action(chara, activator)
  ...
  if SV.global_quest.StoryProgression > 23 then
    local gapori = CH("Gapori")
	UI:SetSpeaker(chara)
    UI:WaitShowDialogue(STRINGS:Format(STRINGS.MapStrings['Girafarig_1']))
	UI:SetSpeaker(gapori)
    UI:WaitShowDialogue(STRINGS:Format(STRINGS.MapStrings['Gapori_7']))
	UI:SetSpeaker(chara)
	UI:SetSpeakerEmotion("Joyous")
	UI:WaitShowDialogue(STRINGS:Format(STRINGS.MapStrings['Girafarig_2']))
	UI:SetSpeaker(gapori)
	UI:SetSpeakerEmotion("Surprised")
    UI:WaitShowDialogue(STRINGS:Format(STRINGS.MapStrings['Gapori_8']))
  else
    UI:WaitShowDialogue(STRINGS:Format(STRINGS.MapStrings['Girafarig_0']))
  end
end
...
function amusement_park.Aron_Action(chara, activator)
  ...
  if SV.global_quest.StoryProgression > 23 then
    local gapori = CH("Gapori")
    UI:WaitShowDialogue(STRINGS:Format(STRINGS.MapStrings['Aron_1']))
	UI:SetSpeaker(gapori)
	UI:SetSpeakerEmotion("Worried")
    UI:WaitShowDialogue(STRINGS:Format(STRINGS.MapStrings['Gapori_9']))
  else
    UI:WaitShowDialogue(STRINGS:Format(STRINGS.MapStrings['Aron_0']))
  end
end
...
function amusement_park.Bayleef_Davi_Action(chara, activator)
  ...
  UI:SetSpeaker(chara)
  UI:SetSpeakerEmotion("Worried")
  UI:WaitShowDialogue(STRINGS:Format(STRINGS.MapStrings['Bayleef_Davi_0']))
  GROUND:CharTurnToChar(grumpig,chara)
  UI:SetSpeaker(grumpig)
  UI:SetSpeakerEmotion("Normal")
  UI:WaitShowDialogue(STRINGS:Format(STRINGS.MapStrings['Grumpig_1']))
end

function amusement_park.Cradily_Davi_Action(chara, activator)
  UI:SetSpeaker(chara)
  UI:SetSpeakerEmotion("Pain")
  UI:WaitShowDialogue(STRINGS:Format(STRINGS.MapStrings['Cradily_Davi_0']))
  UI:ResetSpeaker()
  UI:WaitShowDialogue(STRINGS:Format(STRINGS.MapStrings['Message_4']))
end

function amusement_park.Tinkaton_Action(chara, activator)
  UI:SetSpeaker(chara)
  UI:SetSpeakerEmotion("Pain")
  UI:WaitShowDialogue(STRINGS:Format(STRINGS.MapStrings['Tinkaton_0']))
end
...
function amusement_park.Corviknight_0_Action(chara, activator)
  ...
  UI:SetSpeaker(chara)
  UI:SetSpeakerEmotion("Happy")
  UI:WaitShowDialogue(STRINGS:Format(STRINGS.MapStrings['Corviknight_0_0']))
end
...
function amusement_park.Corviknight_1_Action(chara, activator)
  ...
  UI:SetSpeaker(chara)
  UI:SetSpeakerEmotion("Happy")
  UI:WaitShowDialogue(STRINGS:Format(STRINGS.MapStrings['Corviknight_1_0']))
end
...
function amusement_park.Grumpig_Action(chara, activator)
  ...
  if SV.global_quest.StoryProgression > 11 then
    if quest_ < 3 then
	  ...
	  if quest_ == 0 then
	    UI:WaitShowDialogue(STRINGS:Format(STRINGS.MapStrings['Grumpig_2']))
	    UI:WaitShowDialogue(STRINGS:Format(STRINGS.MapStrings['Grumpig_3']))
	  end
	  if quest_ > 0 and quest_ < 3 and item_slot:IsValid() then
	    if quest_ == 2 then
		  UI:SetSpeakerEmotion("Joyous")
	      UI:WaitShowDialogue(STRINGS:Format(STRINGS.MapStrings['Grumpig_6']))
		  UI:SetSpeakerEmotion("Inspired")
		  UI:WaitShowDialogue(STRINGS:Format(STRINGS.MapStrings['Grumpig_7']))
		  GAME:FadeOut(true, 60)
		  GAME:FadeIn(20)
		  UI:WaitShowDialogue(STRINGS:Format(STRINGS.MapStrings['Grumpig_8']))
		...
		if quest_ == 1 then
		  UI:SetSpeakerEmotion("Happy")
	      UI:WaitShowDialogue(STRINGS:Format(STRINGS.MapStrings['Grumpig_5']))
		end
		quest_ = quest_+1
		GAME:TakePlayerBagItem(item_slot.Slot)
	  else
	    UI:SetSpeakerEmotion("Sad")
	    UI:WaitShowDialogue(STRINGS:Format(STRINGS.MapStrings['Grumpig_4']))
	  end
	  if quest_ == 0 then
	    quest_ = 1
	    COMMONEX.SidequestAccept(questname)
	  ...
	  UI:SetSpeakerEmotion("Joyous")
	  UI:WaitShowDialogue(STRINGS:Format(STRINGS.MapStrings['Grumpig_9']))
	end
  else
    UI:SetSpeakerEmotion("Worried")
    UI:WaitShowDialogue(STRINGS:Format(STRINGS.MapStrings['Grumpig_0']))
  end
...
function amusement_park.Spoink_L_Action(chara, activator)
  ...
  if SV.sidequest.quest02 == 3 then
    UI:SetSpeakerEmotion("Happy")
    UI:WaitShowDialogue(STRINGS:Format(STRINGS.MapStrings['Spoink_L_1']))
  else
    UI:SetSpeakerEmotion("Determined")
    UI:WaitShowDialogue(STRINGS:Format(STRINGS.MapStrings['Spoink_L_0']))
  end
end
...
function amusement_park.Spoink_R_Action(chara, activator)
  ...
  if SV.sidequest.quest02 == 3 then
    UI:SetSpeakerEmotion("Joyous")
    UI:WaitShowDialogue(STRINGS:Format(STRINGS.MapStrings['Spoink_R_1']))
  else
    UI:SetSpeakerEmotion("Determined")
    UI:WaitShowDialogue(STRINGS:Format(STRINGS.MapStrings['Spoink_R_0']))
  end
end
