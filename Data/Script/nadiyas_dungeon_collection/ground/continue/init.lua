...
function continue.Counselor_Action(chara, activator)
  ...
  UI:WaitShowDialogue(STRINGS:Format(MapStrings['Counselor_0']))
  UI:SetSpeakerEmotion("Normal")
  UI:WaitShowDialogue(STRINGS:Format(MapStrings['Counselor_1']))
end

function continue.Teleport_Touch(obj, activator)
  UI:ChoiceMenuYesNo(STRINGS:Format(MapStrings['Message_0']), false)
  UI:WaitForChoice()
