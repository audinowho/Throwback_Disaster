...
function davigny_oceanroom.DungeonEntrance_Touch(obj, activator)
  ...
  if SV.global_quest.StoryProgression > 16 then
	...
	UI:ChoiceMenuYesNo(STRINGS:Format(STRINGS.MapStrings['Powwene_0'], SV.playername), false)
    UI:WaitForChoice()
    ch = UI:ChoiceResult()
    if ch then
...
function davigny_oceanroom.Purrloin_Action(chara, activator)
  ...
  if SV.global_quest.StoryProgression > 26 then
    UI:WaitShowDialogue(STRINGS:Format(STRINGS.MapStrings['Purrloin_5']))
  else
    UI:WaitShowDialogue(STRINGS:Format(STRINGS.MapStrings['Purrloin_0']))
    UI:SetSpeakerEmotion("Surprised")
    if SV.global_quest.StoryProgression > 12 then
      UI:WaitShowDialogue(STRINGS:Format(STRINGS.MapStrings['Purrloin_3']))
      UI:SetSpeakerEmotion("Shouting")
      UI:WaitShowDialogue(STRINGS:Format(STRINGS.MapStrings['Purrloin_4']))
    else
      UI:WaitShowDialogue(STRINGS:Format(STRINGS.MapStrings['Purrloin_1']))
      UI:SetSpeakerEmotion("Worried")
      UI:WaitShowDialogue(STRINGS:Format(STRINGS.MapStrings['Purrloin_2']))
    end
  end
end
...
function davigny_oceanroom.Patrat_Action(chara, activator)
  ...
  if SV.global_quest.StoryProgression > 26 then
	...
	UI:WaitShowDialogue(STRINGS:Format(STRINGS.MapStrings['Patrat_3']))
  else
    UI:SetSpeakerEmotion("Normal")
    UI:WaitShowDialogue(STRINGS:Format(STRINGS.MapStrings['Patrat_0']))
    UI:WaitShowDialogue(STRINGS:Format(STRINGS.MapStrings['Patrat_1']))
    UI:SetSpeakerEmotion("Happy")
    UI:WaitShowDialogue(STRINGS:Format(STRINGS.MapStrings['Patrat_2']))
  end
end
...
function davigny_oceanroom.Phantump_Action(chara, activator)
  ...
  if SV.global_quest.StoryProgression > 26 and SV.sidequest_buneary == 4 then
    UI:SetSpeakerEmotion("Surprised")
	UI:WaitShowDialogue(STRINGS:Format(STRINGS.MapStrings['Phantump_6']))
    UI:SetSpeakerEmotion("Sad")
    UI:WaitShowDialogue(STRINGS:Format(STRINGS.MapStrings['Phantump_7']))
  elseif SV.global_quest.StoryProgression > 26 then
    UI:WaitShowDialogue(STRINGS:Format(STRINGS.MapStrings['Phantump_8']))
  elseif SV.global_quest.StoryProgression > 15 then
    UI:SetSpeakerEmotion("Normal")
	UI:WaitShowDialogue(STRINGS:Format(STRINGS.MapStrings['Phantump_4']))
    UI:SetSpeakerEmotion("Sad")
    UI:WaitShowDialogue(STRINGS:Format(STRINGS.MapStrings['Phantump_5']))
  elseif SV.global_quest.StoryProgression > 14 then
    UI:WaitShowDialogue(STRINGS:Format(STRINGS.MapStrings['Phantump_2']))
    UI:SetSpeakerEmotion("Normal")
    UI:WaitShowDialogue(STRINGS:Format(STRINGS.MapStrings['Phantump_3']))
  else
    UI:WaitShowDialogue(STRINGS:Format(STRINGS.MapStrings['Phantump_0']))
    UI:WaitShowDialogue(STRINGS:Format(STRINGS.MapStrings['Phantump_1']))
  end
end
...
function davigny_oceanroom.Sign_Action(obj, activator)
  UI:ResetSpeaker()
  UI:WaitShowDialogue(STRINGS:Format(STRINGS.MapStrings['Sign_0']))
end
