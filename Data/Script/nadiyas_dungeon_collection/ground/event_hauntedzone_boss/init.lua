...
function event_hauntedzone_boss.Enter(map)
  ...
  if SV.sidequest_buneary == 2 then
	...
	UI:SetSpeaker(mis_0)
	UI:WaitShowDialogue(STRINGS:Format(STRINGS.MapStrings['Mismagius_0']))
	UI:SetSpeaker(mis_1)
	UI:SetSpeakerEmotion("Stunned")
	UI:WaitShowDialogue(STRINGS:Format(STRINGS.MapStrings['Misdreavus_0']))
	UI:SetSpeaker(mis_0)
	UI:SetSpeakerEmotion("Angry")
	UI:WaitShowDialogue(STRINGS:Format(STRINGS.MapStrings['Mismagius_1']))
	UI:WaitShowDialogue(STRINGS:Format(STRINGS.MapStrings['Mismagius_2']))
	...
	UI:WaitShowDialogue(STRINGS:Format(STRINGS.MapStrings['Mismagius_3']))
	...
	UI:WaitShowDialogue(STRINGS:Format(STRINGS.MapStrings['Buneary_3']))
	UI:WaitShowDialogue(STRINGS:Format(STRINGS.MapStrings['Buneary_4']))
