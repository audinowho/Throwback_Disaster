...
function amusement_castle.Enter(map)
  ...
  if SV.global_quest.StoryProgression == 4 then
	...
	UI:WaitShowDialogue(STRINGS:Format(STRINGS.MapStrings['Espurr_0']))
	UI:SetSpeaker(vit)
	UI:SetSpeakerEmotion("Normal")
	UI:WaitShowDialogue(STRINGS:Format(STRINGS.MapStrings['Vitaro_0']))
	UI:SetSpeaker(mic)
	UI:SetSpeakerEmotion("Sad")
	UI:WaitShowDialogue(STRINGS:Format(STRINGS.MapStrings['Minccino_0']))
	UI:WaitShowDialogue(STRINGS:Format(STRINGS.MapStrings['Minccino_1']))
	UI:SetSpeaker(vit)
  ...
  if SV.global_quest.StoryProgression == 19 then
    ...
    UI:WaitShowDialogue(STRINGS:Format(STRINGS.MapStrings['Nidoqueen_3']))
	...
	UI:SetSpeaker(nidoqueen)
    UI:SetSpeakerEmotion("Determined")
    UI:WaitShowDialogue(STRINGS:Format(STRINGS.MapStrings['Nidoqueen_4']))
	...
	UI:WaitShowDialogue(STRINGS:Format(STRINGS.MapStrings['Nidoqueen_5']))
	GAME:FadeOut(false,20)
...
function amusement_castle.InvasionEvent_Touch(obj, activator)
  ...
  UI:SetSpeakerEmotion("Determined")
  UI:WaitShowDialogue(STRINGS:Format(STRINGS.MapStrings['Nidoqueen_0']))
  UI:WaitShowDialogue(STRINGS:Format(STRINGS.MapStrings['Nidoqueen_1']))
  UI:SetSpeakerEmotion("Angry")
  UI:WaitShowDialogue(STRINGS:Format(STRINGS.MapStrings['Nidoqueen_2']))
  UI:SetSpeaker(STRINGS:Format("[color=#00FFFF]Nidorans[color]"), true, "", -1, "", RogueEssence.Data.Gender.Unknown)
  UI:WaitShowDialogue(STRINGS:Format(STRINGS.MapStrings['Nidoran_0']))
...
function amusement_castle.Slowking_Action(chara, activator)
  GROUND:CharTurnToChar(chara,CH('PLAYER'))
  UI:SetSpeaker(chara)
  UI:WaitShowDialogue(STRINGS:Format(STRINGS.MapStrings['Slowking_0']))
end

function amusement_castle.Slowpoke_L_Action(chara, activator)
  GROUND:CharTurnToChar(chara,CH('PLAYER'))
  UI:SetSpeaker(chara)
  UI:WaitShowDialogue(STRINGS:Format(STRINGS.MapStrings['SlowpokeL_0']))
end

function amusement_castle.Slowpoke_R_Action(chara, activator)
  GROUND:CharTurnToChar(chara,CH('PLAYER'))
  UI:SetSpeaker(chara)
  UI:WaitShowDialogue(STRINGS:Format(STRINGS.MapStrings['SlowpokeR_0']))
end
...
function amusement_castle.Vitaro_Action(chara, activator)
  if SV.global_quest.StoryProgression == 5 then
	...
	GROUND:CharTurnToChar(chara,CH('PLAYER'))
	UI:SetSpeaker(chara)
	UI:WaitShowDialogue(STRINGS:Format(STRINGS.MapStrings['Vitaro_2']))
	GAME:FadeOut(false,20)
	GAME:CutsceneMode(true)
	...
	GAME:FadeIn(20)
	UI:SetSpeaker(swk)
	UI:WaitShowDialogue(STRINGS:Format(STRINGS.MapStrings['Slowking_1']))
	UI:WaitShowDialogue(STRINGS:Format(STRINGS.MapStrings['Slowking_2']))
	local ch = false
	local name = ""
	while not ch do
	name = ""
	while name == "" do
	  ...
	  UI:ChoiceMenuYesNo(STRINGS:Format(STRINGS.MapStrings['Slowking_3'], name), true)
	  UI:WaitForChoice()
	  ch = UI:ChoiceResult()
	end
	GAME:SetTeamName(name)
	UI:WaitShowDialogue(STRINGS:Format(STRINGS.MapStrings['Slowking_4']))
	UI:WaitShowDialogue(STRINGS:Format(STRINGS.MapStrings['Slowking_5']))
	UI:WaitShowDialogue(STRINGS:Format(STRINGS.MapStrings['Slowking_6']))
	UI:WaitShowDialogue(STRINGS:Format(STRINGS.MapStrings['Slowking_7'], name))
	UI:WaitShowDialogue(STRINGS:Format(STRINGS.MapStrings['Slowking_8']))
	UI:SetSpeakerEmotion("Happy")
	UI:WaitShowDialogue(STRINGS:Format(STRINGS.MapStrings['Slowking_9']))
	UI:SetSpeaker(chara)
	GROUND:CharAnimateTurn(chara, Direction.Right, 4, true)
	GROUND:CharAnimateTurn(CH('PLAYER'), Direction.Left, 4, true)
	UI:WaitShowDialogue(STRINGS:Format(STRINGS.MapStrings['Vitaro_3']))
	GAME:FadeOut(false,20)
	GAME:CutsceneMode(false)
	GROUND:RemoveCharacter("Vitaro")
