...
function event_waterfallaccident.Enter(map)
  ...
  UI:WaitShowDialogue(STRINGS:Format(STRINGS.MapStrings['Espurr_1']))
  GROUND:CharAnimateTurn(minccino, Direction.Left, 4, true)
  UI:SetSpeaker(minccino)
  UI:SetSpeakerEmotion("Determined")
  UI:WaitShowDialogue(STRINGS:Format(STRINGS.MapStrings['Minccino_1'], SV.playername))
  UI:SetSpeaker(espurr)
  UI:SetSpeakerEmotion("Worried")
  UI:WaitShowDialogue(STRINGS:Format(STRINGS.MapStrings['Espurr_2']))
  UI:SetSpeaker(minccino)
  UI:SetSpeakerEmotion("Normal")
  UI:WaitShowDialogue(STRINGS:Format(STRINGS.MapStrings['Minccino_2']))
  ...
  UI:WaitShowDialogue(STRINGS:Format(STRINGS.MapStrings['Espurr_3'], player:GetDisplayName()))
  GROUND:CharSetEmote(minccino, "sweating", 1)
  SOUND:PlayBattleSE("EVT_Emote_Sweating")
  GAME:WaitFrames(30)
  UI:SetSpeaker(minccino)
  UI:SetSpeakerEmotion("Sad")
  UI:WaitShowDialogue(STRINGS:Format(STRINGS.MapStrings['Minccino_3']))
  UI:ResetSpeaker()
