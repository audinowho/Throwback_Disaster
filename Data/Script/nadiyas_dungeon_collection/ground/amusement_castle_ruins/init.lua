...
function amusement_castle_ruins.Enter(map)
  ...
  if SV.global_quest.StoryProgression == 21 then
    ...
    UI:WaitShowDialogue(STRINGS:Format(STRINGS.MapStrings['Misdreavus_2']))
...
function amusement_castle_ruins.Mantine_Action(chara, activator)
  UI:SetSpeaker(chara)
  UI:SetSpeakerEmotion("Worried")
  UI:WaitShowDialogue(STRINGS:Format(STRINGS.MapStrings['Mantine_0']))
end

function amusement_castle_ruins.Scyther_Action(chara, activator)
  UI:SetSpeaker(chara)
  UI:SetSpeakerEmotion("Angry")
  UI:WaitShowDialogue(STRINGS:Format(STRINGS.MapStrings['Scyther_0']))
end
...
function amusement_castle_ruins.Cim_Action(chara, activator)
  ...
  if SV.global_quest.StoryProgression == 29 then
	...
	UI:SetSpeaker(chara)
    UI:WaitShowDialogue(STRINGS:Format(STRINGS.MapStrings['Cim_0']))
    UI:WaitShowDialogue(STRINGS:Format(STRINGS.MapStrings['Cim_1']))
    UI:SetSpeakerEmotion("Happy")
    UI:WaitShowDialogue(STRINGS:Format(STRINGS.MapStrings['Cim_2']))
    UI:WaitShowDialogue(STRINGS:Format(STRINGS.MapStrings['Cim_3']))
	chara.Data.Nickname = "Cim"
	UI:SetSpeaker(chara)
    UI:WaitShowDialogue(STRINGS:Format(STRINGS.MapStrings['Cim_4']))
	UI:SetSpeaker(gapori)
    UI:WaitShowDialogue(STRINGS:Format(STRINGS.MapStrings['Gapori_18'], SV.playername))
	UI:SetSpeaker(chara)
	UI:SetSpeakerEmotion("Worried")
    UI:WaitShowDialogue(STRINGS:Format(STRINGS.MapStrings['Cim_5']))
	UI:SetSpeaker(gapori)
	UI:SetSpeakerEmotion("Worried")
    UI:WaitShowDialogue(STRINGS:Format(STRINGS.MapStrings['Gapori_19']))
	UI:SetSpeaker(chara)
	UI:SetSpeakerEmotion("Sad")
    UI:WaitShowDialogue(STRINGS:Format(STRINGS.MapStrings['Cim_6']))
	SV.global_quest.StoryProgression = 30
	GROUND:Unhide("WaitUp")
  end
  UI:SetSpeakerEmotion("Happy")
  UI:WaitShowDialogue(STRINGS:Format(STRINGS.MapStrings['Cim_7']))
end
...
function amusement_castle_ruins.Braixen_Action(chara, activator)
  ...
  GROUND:CharTurnToChar(chara,CH('PLAYER'))
  UI:SetSpeakerEmotion("Worried")
  UI:WaitShowDialogue(STRINGS:Format(STRINGS.MapStrings['Braixen_0']))
  UI:SetSpeakerEmotion("Determined")
  UI:WaitShowDialogue(STRINGS:Format(STRINGS.MapStrings['Braixen_1']))
  UI:WaitShowDialogue(STRINGS:Format(STRINGS.MapStrings['Braixen_2']))
end
...
function amusement_castle_ruins.Wigglytuff_Action(chara, activator)
  ...
  if SV.global_quest.StoryProgression > 28 then
    UI:SetSpeakerEmotion("Happy")
    UI:WaitShowDialogue(STRINGS:Format(STRINGS.MapStrings['Wigglytuff_2']))
  else
    UI:SetSpeakerEmotion("Worried")
    UI:WaitShowDialogue(STRINGS:Format(STRINGS.MapStrings['Wigglytuff_0']))
    UI:SetSpeakerEmotion("Surprised")
    UI:WaitShowDialogue(STRINGS:Format(STRINGS.MapStrings['Wigglytuff_1']))
  end
end
...
function amusement_castle_ruins.Bellossom_Action(chara, activator)
  GROUND:CharTurnToChar(chara,CH('PLAYER'))
  UI:SetSpeaker(chara)
  UI:WaitShowDialogue(STRINGS:Format(STRINGS.MapStrings['Bellossom_0']))
  UI:SetSpeakerEmotion("Joyous")
  UI:BeginChoiceMenu(STRINGS:Format(STRINGS.MapStrings['Bellossom_1']),
  {STRINGS:Format(STRINGS.MapStrings['Answer_1']),
  STRINGS:Format(STRINGS.MapStrings['Answer_2']),
  STRINGS:Format(STRINGS.MapStrings['Answer_3'])}, 1, 4)
  UI:WaitForChoice()
  UI:SetSpeakerEmotion("Happy")
  UI:WaitShowDialogue(STRINGS:Format(STRINGS.MapStrings['Bellossom_2']))
  UI:WaitShowDialogue(STRINGS:Format(STRINGS.MapStrings['Bellossom_3']))
end
...
function amusement_castle_ruins.WaitUp_Touch(obj, activator)
  ...
  if SV.global_quest.StoryProgression == 24 then
	...
	UI:WaitShowDialogue(STRINGS:Format(STRINGS.MapStrings['Message_0'], SV.playername))
