...
function event_oriental_celebi.Enter(map)
  ...
  if SV.hiddensidequest.celebi == 2 then
	...
	UI:ChoiceMenuYesNo(STRINGS:Format(STRINGS.MapStrings['Powwene_9']),true)
	UI:WaitForChoice()
	result = UI:ChoiceResult()
	if result then
	  UI:SetSpeakerEmotion("Sigh")
	  UI:WaitShowDialogue(STRINGS:Format(STRINGS.MapStrings['Powwene_10_Y']))
	else
	  UI:SetSpeakerEmotion("Sad")
	  UI:WaitShowDialogue(STRINGS:Format(STRINGS.MapStrings['Powwene_10_N']))
	end
	...
	UI:SetSpeakerEmotion("Worried")
	UI:BeginChoiceMenu(STRINGS:Format(STRINGS.MapStrings['Powwene_3']),
	{STRINGS:Format(STRINGS.MapStrings['Answer_1_A']),
	STRINGS:Format(STRINGS.MapStrings['Answer_1_B']),
	STRINGS:Format(STRINGS.MapStrings['Answer_1_C']),
	STRINGS:Format(STRINGS.MapStrings['Answer_1_D'])}, 1, 1)
	UI:WaitForChoice()
	result = UI:ChoiceResult()
	GROUND:CharAnimateTurn(powwene, Direction.Down, 4, false)
	if result == 1 then
	  UI:SetSpeakerEmotion("Surprised")
	  UI:WaitShowDialogue(STRINGS:Format(STRINGS.MapStrings['Powwene_4_A']))
	end
	if result == 2 then
	  UI:SetSpeakerEmotion("Worried")
	  UI:WaitShowDialogue(STRINGS:Format(STRINGS.MapStrings['Powwene_4_B']))
	end
	if result == 3 then
	  UI:SetSpeakerEmotion("Worried")
	  UI:WaitShowDialogue(STRINGS:Format(STRINGS.MapStrings['Powwene_4_C']))
	end
	if result == 4 then
	  UI:SetSpeakerEmotion("Worried")
	  UI:WaitShowDialogue(STRINGS:Format(STRINGS.MapStrings['Powwene_4_D']))
	end
	...
	UI:SetSpeakerEmotion("Worried")
	UI:WaitShowDialogue(STRINGS:Format(STRINGS.MapStrings['Powwene_5'], SV.playername))
	UI:SetSpeakerEmotion("Sad")
	...
	UI:WaitShowDialogue(STRINGS:Format(STRINGS.MapStrings['Celebi_0']))
	...
	UI:WaitShowDialogue(STRINGS:Format(STRINGS.MapStrings['Celebi_1']))
	UI:SetSpeaker(powwene)
