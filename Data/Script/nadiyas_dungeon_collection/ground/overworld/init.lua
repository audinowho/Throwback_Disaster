...
function overworld.Quest4Bounty_Action(chara, activator)
  ...
  UI:WaitShowDialogue(STRINGS:Format(MapStrings['Quest4Bounty_0']))
  UI:WaitShowDialogue(STRINGS:Format(MapStrings['Quest4Bounty_1']))
  UI:ChoiceMenuYesNo(STRINGS:Format(MapStrings['Quest4Bounty_2']), false)
  UI:WaitForChoice()
  result = UI:ChoiceResult()
  if result then
    UI:SetSpeakerEmotion("Angry")
	UI:WaitShowDialogue(STRINGS:Format(MapStrings['Quest4Bounty_3']))
