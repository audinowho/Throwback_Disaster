...
function davigny.Enter(map)
  ...
  if SV.global_quest.StoryProgression == 27 then
    ...
    UI:WaitShowDialogue(STRINGS:Format(STRINGS.MapStrings['Togetic_3'],GAME:GetTeamName()))
	...
	UI:SetSpeaker(togetic)
    UI:SetSpeakerEmotion("Worried")
    UI:WaitShowDialogue(STRINGS:Format(STRINGS.MapStrings['Togetic_4']))
	UI:WaitShowDialogue(STRINGS:Format(STRINGS.MapStrings['Togetic_5']))
	UI:SetSpeaker(gapori)
    UI:SetSpeakerEmotion("Worried")
    UI:WaitShowDialogue(STRINGS:Format(STRINGS.MapStrings['Gapori_10']))
	UI:SetSpeaker(togetic)
    UI:SetSpeakerEmotion("Sad")
    UI:WaitShowDialogue(STRINGS:Format(STRINGS.MapStrings['Togetic_6']))
	UI:SetSpeakerEmotion("Normal")
	UI:WaitShowDialogue(STRINGS:Format(STRINGS.MapStrings['Togetic_7']))
  ...
  if SV.wipedout == true then
	...
	UI:WaitShowDialogue(STRINGS:Format(STRINGS.MapStrings['Togetic_Wipeout_0']))
	UI:SetSpeakerEmotion("Worried")
	UI:WaitShowDialogue(STRINGS:Format(STRINGS.MapStrings['Togetic_Wipeout_1']))
	UI:WaitShowDialogue(STRINGS:Format(STRINGS.MapStrings['Togetic_Wipeout_2']))
	SV.wipedout = false
  end
...
function davigny.Misdreavus_Action(chara, activator)
  ...
  UI:WaitShowDialogue(STRINGS:Format(STRINGS.MapStrings['Zigzagoon_0']))
  UI:SetSpeakerEmotion("Stunned")
  UI:WaitShowDialogue(STRINGS:Format(STRINGS.MapStrings['Zigzagoon_1']))
  UI:SetSpeaker(chara)
  UI:SetSpeakerEmotion("Surprised")
  UI:WaitShowDialogue(STRINGS:Format(STRINGS.MapStrings['Misdreavus_0']))
  UI:SetSpeaker(zig)
  UI:SetSpeakerEmotion("Stunned")
  UI:WaitShowDialogue(STRINGS:Format(STRINGS.MapStrings['Zigzagoon_2']))
  GROUND:MoveInDirection(zig, Direction.Down, 24, true, 3)
  GROUND:Hide("Zigzagoon")
  UI:SetSpeaker(chara)
  UI:SetSpeakerEmotion("Stunned")
  UI:WaitShowDialogue(STRINGS:Format(STRINGS.MapStrings['Misdreavus_1']))
  UI:SetSpeaker(shu)
  UI:SetSpeakerEmotion("Worried")
  UI:WaitShowDialogue(STRINGS:Format(STRINGS.MapStrings['Shuppet_0']))
...
function davigny.Buneary_Action(chara, activator)
  ...
  if SV.sidequest_buneary == 0 then
	...
	UI:WaitShowDialogue(STRINGS:Format(STRINGS.MapStrings['Buneary_0']))
    UI:SetSpeakerEmotion("Determined")
    UI:WaitShowDialogue(STRINGS:Format(STRINGS.MapStrings['Buneary_1']))
    chara.CollisionDisabled = true
    GROUND:MoveToPosition(chara, 196, 484, false, 2)
    GROUND:Hide("Buneary")
    SV.sidequest_buneary = 1
  else
    UI:WaitShowDialogue(STRINGS:Format(STRINGS.MapStrings['Buneary_2']))
	UI:ResetSpeaker()
...
function davigny.Shuppet_Action(chara, activator)
  ...
  if SV.global_quest.StoryProgression == 17 then
	UI:SetSpeakerEmotion("Worried")
	UI:WaitShowDialogue(STRINGS:Format(STRINGS.MapStrings['Shuppet_1']))
  else
    GROUND:CharTurnToChar(chara,player)
	UI:SetSpeakerEmotion("Sad")
	UI:WaitShowDialogue(STRINGS:Format(STRINGS.MapStrings['Shuppet_2']))
  end
end
...
function davigny.Nuzleaf_Action(chara, activator)
  ...
  if SV.sidequest.quest05 == 2 then
	...
	UI:WaitShowDialogue(STRINGS:Format(STRINGS.MapStrings['Nuzleaf_10']))
  else
	UI:WaitShowDialogue(STRINGS:Format(STRINGS.MapStrings['Nuzleaf_0']))
	UI:WaitShowDialogue(STRINGS:Format(STRINGS.MapStrings['Nuzleaf_1']))
	UI:WaitShowDialogue(STRINGS:Format(STRINGS.MapStrings['Nuzleaf_2']))
	UI:WaitShowDialogue(STRINGS:Format(STRINGS.MapStrings['Nuzleaf_3']))
	UI:WaitShowDialogue(STRINGS:Format(STRINGS.MapStrings['Nuzleaf_4']))
	UI:WaitShowDialogue(STRINGS:Format(STRINGS.MapStrings['Nuzleaf_5']))
	UI:WaitShowDialogue(STRINGS:Format(STRINGS.MapStrings['Nuzleaf_6']))
	if SV.NuzleafTalk == false then
      UI:WaitShowDialogue(STRINGS:Format(STRINGS.MapStrings['Nuzleaf_7']))
	  UI:WaitShowDialogue(STRINGS:Format(STRINGS.MapStrings['Nuzleaf_8']))
	  UI:WaitShowDialogue(STRINGS:Format(STRINGS.MapStrings['Nuzleaf_9']))
	  SV.NuzleafTalk = true
	  GAME:UnlockDungeon('td_pinkandblue')
	end
  end
...
if SV.davigny.MachopExplain == false then
  ...
  local ch = false
  UI:WaitShowDialogue(STRINGS:Format(STRINGS.MapStrings['Machop_0']))
  while not ch do
	UI:SetSpeakerEmotion("Normal")
	UI:WaitShowDialogue(STRINGS:Format(STRINGS.MapStrings['Machop_1']))
	UI:WaitShowDialogue(STRINGS:Format(STRINGS.MapStrings['Machop_2']))
	UI:WaitShowDialogue(STRINGS:Format(STRINGS.MapStrings['Machop_3']))
	UI:ChoiceMenuYesNo(STRINGS:Format(STRINGS.MapStrings['Machop_4']), false)
	UI:WaitForChoice()
	ch = UI:ChoiceResult()
	if not ch then
	  UI:SetSpeakerEmotion("Worried")
	  UI:WaitShowDialogue(STRINGS:Format(STRINGS.MapStrings['Machop_5']))
	end
  end
  UI:SetSpeakerEmotion("Normal")
  UI:WaitShowDialogue(STRINGS:Format(STRINGS.MapStrings['Machop_6']))
  COMMON.GiftItem(player, RogueEssence.Dungeon.InvItem("seed_reviver"))
  UI:SetSpeaker(machop)
  UI:SetSpeakerEmotion("Happy")
  UI:WaitShowDialogue(STRINGS:Format(STRINGS.MapStrings['Machop_7']))
...
function davigny.Bayleef_Action(chara, activator)
  ...
  if quest_ < 2 then
	if quest_ == 0 then
	  UI:WaitShowDialogue(STRINGS:Format(STRINGS.MapStrings['Bayleef_0']))
	end
	local item_slot = GAME:FindPlayerItem('berry_lum',false,true)
	if quest_ == 1 and item_slot:IsValid() then
	  UI:SetSpeakerEmotion("Surprised")
	  UI:WaitShowDialogue(STRINGS:Format(STRINGS.MapStrings['Bayleef_3']))
	  UI:SetSpeakerEmotion("Joyous")
	  GAME:TakePlayerBagItem(item_slot.Slot)
	  UI:WaitShowDialogue(STRINGS:Format(STRINGS.MapStrings['Bayleef_4']))
	  ...
	  UI:SetSpeakerEmotion("Sad")
	  UI:WaitShowDialogue(STRINGS:Format(STRINGS.MapStrings['Bayleef_1']))
	  UI:WaitShowDialogue(STRINGS:Format(STRINGS.MapStrings['Bayleef_2']))
	end
	if quest_ == 0 then
	  quest_ = 1
...
function davigny.Natu_Action(chara, activator)
  GROUND:CharTurnToChar(chara,CH('PLAYER'))
  UI:SetSpeaker(chara)
  UI:WaitShowDialogue(STRINGS:Format(STRINGS.MapStrings['Natu_0']))
  UI:WaitShowDialogue(STRINGS:Format(STRINGS.MapStrings['Natu_1']))
end
...
function davigny.Corsola_Action(chara, activator)
  ...
  if SV.sidequest.quest05 == 2 then
	...
	UI:SetSpeaker(chara)
	UI:SetSpeakerEmotion("Angry")
	UI:WaitShowDialogue(STRINGS:Format(STRINGS.MapStrings['Corsola_6']))
  elseif SV.global_quest.StoryProgression == 12 and SV.davigny.CorsolaMove == false then
	...
	UI:WaitShowDialogue(STRINGS:Format(STRINGS.MapStrings['Corsola_1']))
	...
	UI:SetSpeaker(chara)
	UI:SetSpeakerEmotion("Stunned")
	UI:WaitShowDialogue(STRINGS:Format(STRINGS.MapStrings['Corsola_2']))
	UI:SetSpeaker(powwene)
	UI:SetSpeakerEmotion("Angry")
	...
	UI:SetSpeaker(chara)
	UI:SetSpeakerEmotion("Surprised")
	UI:WaitShowDialogue(STRINGS:Format(STRINGS.MapStrings['Corsola_3']))
	...
	UI:SetSpeaker(chara)
	UI:SetSpeakerEmotion("Pain")
	UI:WaitShowDialogue(STRINGS:Format(STRINGS.MapStrings['Corsola_4']))
	UI:SetSpeakerEmotion("Sad")
	UI:WaitShowDialogue(STRINGS:Format(STRINGS.MapStrings['Corsola_5']))
	GAME:FadeOut(false, 20)
	...
	UI:SetSpeaker(chara)
	UI:SetSpeakerEmotion("Worried")
	UI:WaitShowDialogue(STRINGS:Format(STRINGS.MapStrings['Corsola_0']))
  end
end
...
function davigny.Mankey_Action(chara, activator)
  ...
  UI:SetSpeaker(chara)
  if SV.global_quest.StoryProgression == 8 then
	UI:WaitShowDialogue(STRINGS:Format(STRINGS.MapStrings['Mankey_0'],GAME:GetTeamName()))
	UI:WaitShowDialogue(STRINGS:Format(STRINGS.MapStrings['Mankey_1']))
	UI:WaitShowDialogue(STRINGS:Format(STRINGS.MapStrings['Mankey_2']))
  ...
  elseif SV.global_quest.StoryProgression == 22 then
    UI:WaitShowDialogue(STRINGS:Format(STRINGS.MapStrings['Mankey_3']))
	UI:WaitShowDialogue(STRINGS:Format(STRINGS.MapStrings['Mankey_4']))
  ...
  elseif SV.global_quest.StoryProgression == 25 then
	...
	UI:WaitShowDialogue(STRINGS:Format(STRINGS.MapStrings['Mankey_5']))
	UI:SetSpeaker(gapori)
	UI:WaitShowDialogue(STRINGS:Format(STRINGS.MapStrings['Gapori_0']))
	UI:SetSpeaker(chara)
	UI:WaitShowDialogue(STRINGS:Format(STRINGS.MapStrings['Mankey_6']))
	UI:WaitShowDialogue(STRINGS:Format(STRINGS.MapStrings['Mankey_7']))
	UI:SetSpeaker(gapori)
	UI:SetSpeakerEmotion("Worried")
	UI:WaitShowDialogue(STRINGS:Format(STRINGS.MapStrings['Gapori_1']))
	UI:SetSpeaker(chara)
	UI:WaitShowDialogue(STRINGS:Format(STRINGS.MapStrings['Mankey_8']))
	UI:SetSpeaker(gapori)
	UI:SetSpeakerEmotion("Sad")
	...
	GAME:WaitFrames(30)
	UI:SetSpeaker(chara)
	UI:WaitShowDialogue(STRINGS:Format(STRINGS.MapStrings['Mankey_9']))
	UI:SetSpeakerEmotion("Happy")
	UI:WaitShowDialogue(STRINGS:Format(STRINGS.MapStrings['Mankey_10']))
	UI:SetSpeaker(gapori)
	UI:SetSpeakerEmotion("Angry")
	...
	UI:SetSpeaker(chara)
	UI:SetSpeakerEmotion("Happy")
	UI:WaitShowDialogue(STRINGS:Format(STRINGS.MapStrings['Mankey_11']))
	UI:SetSpeaker(gapori)
	UI:SetSpeakerEmotion("Angry")
	UI:WaitShowDialogue(STRINGS:Format(STRINGS.MapStrings['Gapori_4'], SV.playername))
...
function davigny.Chinchou_Action(chara, activator)
  ...
  if SV.global_quest.StoryProgression > 25 then
    if quest_ == 0 then
	  UI:SetSpeakerEmotion("Worried")
	  UI:WaitShowDialogue(STRINGS:Format(STRINGS.MapStrings['Chinchou_4']))
	  UI:WaitShowDialogue(STRINGS:Format(STRINGS.MapStrings['Chinchou_5']))
	  UI:SetSpeakerEmotion("Sad")
      UI:WaitShowDialogue(STRINGS:Format(STRINGS.MapStrings['Chinchou_6']))
	  quest_ = 1
      COMMONEX.SidequestAccept(questname)
	else
      if player.CurrentForm.Species == "luvdisc" then
        UI:WaitShowDialogue(STRINGS:Format(STRINGS.MapStrings['Chinchou_7']))
		UI:SetSpeaker(player)
		UI:SetSpeakerEmotion("Worried")
        UI:WaitShowDialogue(STRINGS:Format(STRINGS.MapStrings['Player_Luvdisc_0']))
		UI:SetSpeaker(chara)
		UI:SetSpeakerEmotion("Worried")
        UI:WaitShowDialogue(STRINGS:Format(STRINGS.MapStrings['Chinchou_8']))
		UI:SetSpeaker(player)
        UI:WaitShowDialogue(STRINGS:Format(STRINGS.MapStrings['Player_Luvdisc_1']))
		UI:SetSpeaker(chara)
		UI:SetSpeakerEmotion("Happy")
        UI:WaitShowDialogue(STRINGS:Format(STRINGS.MapStrings['Chinchou_9']))
		quest_ = 2
    ...
    if SV.davigny.CorsolaMove == false then
	  UI:WaitShowDialogue(STRINGS:Format(STRINGS.MapStrings['Chinchou_0']))
	  UI:WaitShowDialogue(STRINGS:Format(STRINGS.MapStrings['Chinchou_1']))
      UI:WaitShowDialogue(STRINGS:Format(STRINGS.MapStrings['Chinchou_2']))
    else
	  UI:WaitShowDialogue(STRINGS:Format(STRINGS.MapStrings['Chinchou_3']))
    end
  end
...
function davigny.Cradily_Action(chara, activator)
  ...
  if quest_ == 2 then
	...
	if quest_ == 1 and GAME:GetPlayerBagItem(item_slot.Slot).Amount >= 4 then
	  UI:WaitShowDialogue(STRINGS:Format(STRINGS.MapStrings['Cradily_2']))
	  UI:SetSpeakerEmotion("Happy")
	  GAME:TakePlayerBagItem(item_slot.Slot)
	  UI:WaitShowDialogue(STRINGS:Format(STRINGS.MapStrings['Cradily_3']))
	  ...
	  UI:SetSpeakerEmotion("Worried")
	  UI:WaitShowDialogue(STRINGS:Format(STRINGS.MapStrings['Cradily_0']))
	  if quest_ == 0 then
  		UI:SetSpeakerEmotion("Normal")
		UI:WaitShowDialogue(STRINGS:Format(STRINGS.MapStrings['Cradily_1']))
		quest_ = 1
		COMMONEX.SidequestAccept(questname)
	  end
	end
...
function davigny.Priest_Action(chara, activator)
  ...
  UI:SetSpeaker(chara)
  local ch = false
  UI:ChoiceMenuYesNo(STRINGS:Format(STRINGS.MapStrings['Togetic_0']), true)
  UI:WaitForChoice()
  ch = UI:ChoiceResult()
  if ch then
	SV.checkpoint = 
	...
	UI:WaitShowDialogue(STRINGS:Format(STRINGS.MapStrings['Togetic_1']))
	UI:SetSpeakerEmotion("Happy")
	UI:WaitShowDialogue(STRINGS:Format(STRINGS.MapStrings['Togetic_2']))
  end
end
...
function davigny.Mamel_Action(chara, activator)
  ...
  if SV.sidequest.quest05 == 2 then
	UI:SetSpeakerEmotion("Angry")
	UI:WaitShowDialogue(STRINGS:Format(STRINGS.MapStrings['Mamel_3']))
  else
    UI:WaitShowDialogue(STRINGS:Format(STRINGS.MapStrings['Mamel_0'], CH('PLAYER').Data.Nickname))
    UI:WaitShowDialogue(STRINGS:Format(STRINGS.MapStrings['Mamel_1']))
    UI:SetSpeakerEmotion("Worried")
    UI:WaitShowDialogue(STRINGS:Format(STRINGS.MapStrings['Mamel_2']))
  end
end
...
function davigny.ChildPark_Pichu_Action(chara, activator)
  ...
  if SV.sidequest.quest06 > 1 then
    UI:SetSpeakerEmotion("Sad")
	UI:WaitShowDialogue(STRINGS:Format(STRINGS.MapStrings['Pichu_4']))
  elseif SV.global_quest.StoryProgression > 16 then
    UI:SetSpeakerEmotion("Happy")
	UI:WaitShowDialogue(STRINGS:Format(STRINGS.MapStrings['Pichu_3']))
...
function davigny.ChildPark_Wooper_Action(chara, activator)
  ...
  if SV.sidequest.quest06 > 1 then
    UI:SetSpeakerEmotion("Worried")
	UI:WaitShowDialogue(STRINGS:Format(STRINGS.MapStrings['Wooper_2']))
  elseif SV.global_quest.StoryProgression > 16 then
	UI:WaitShowDialogue(STRINGS:Format(STRINGS.MapStrings['Wooper_1']))
  else
    UI:SetSpeakerEmotion("Worried")
    UI:WaitShowDialogue(STRINGS:Format(STRINGS.MapStrings['Wooper_0']))
  end
end
...
function davigny.ChildPark_Smoochum_Action(chara, activator)
  ...
  if SV.sidequest.quest06 > 1 then
	...
	UI:WaitShowDialogue(STRINGS:Format(STRINGS.MapStrings['Smoochum_3']))
  else
	UI:SetSpeakerEmotion("Happy")
	UI:WaitShowDialogue(STRINGS:Format(STRINGS.MapStrings['Smoochum_0']))
	UI:SetSpeakerEmotion("Worried")
	UI:WaitShowDialogue(STRINGS:Format(STRINGS.MapStrings['Smoochum_1']))
	UI:SetSpeakerEmotion("Normal")
	UI:WaitShowDialogue(STRINGS:Format(STRINGS.MapStrings['Smoochum_2']))
  end
end
