...
function lot_emolga.TreasureBox_Action(chara, activator)
  if SV.sidequest.quest03 == 3 then
	...
	UI:WaitShowDialogue(STRINGS:Format(STRINGS.MapStrings['Emolga_9']))
  end
end
...
function lot_emolga.House_Touch(chara, activator)
  if SV.sidequest.quest03 > 2 then
	...
	UI:WaitShowDialogue(STRINGS:Format(STRINGS.MapStrings['Emolga_10']))
  end
end
...
function lot_emolga.Hoppip_Action(chara, activator)
  ...
  if SV.sidequest.quest03 == 2 then
    ...
    UI:WaitShowDialogue(STRINGS:Format(STRINGS.MapStrings['Emolga_11']))
	...
	UI:WaitShowDialogue(STRINGS:Format(STRINGS.MapStrings['Hoppip_4']))
  else
    GROUND:CharTurnToChar(chara,CH('PLAYER'))
	UI:WaitShowDialogue(STRINGS:Format(STRINGS.MapStrings['Hoppip_4']))
  end
...
function lot_emolga.Emolga_Action(chara, activator)
  ...
  if SV.sidequest.quest03 > 3 then
	...
	if SV.lot_emolga.chat > 0 then
      ...
      UI:WaitShowDialogue(STRINGS:Format(STRINGS.MapStrings['Emolga_15']))
	else
	  UI:SetSpeakerEmotion("Surprised")
      UI:WaitShowDialogue(STRINGS:Format(STRINGS.MapStrings['Emolga_12']))
      UI:SetSpeakerEmotion("Pain")
      UI:WaitShowDialogue(STRINGS:Format(STRINGS.MapStrings['Emolga_13']))
  	  UI:WaitShowDialogue(STRINGS:Format(STRINGS.MapStrings['Emolga_14']))
  ...
  local powwene = CH('Powwene')
    if hid == 0 then
	  UI:SetSpeaker(chara)
	  UI:WaitShowDialogue(STRINGS:Format(STRINGS.MapStrings['Emolga_1']))
	  UI:SetSpeakerEmotion("Pain")
	  UI:WaitShowDialogue(STRINGS:Format(STRINGS.MapStrings['Emolga_2']))
	  if SV.global_quest.StoryProgression < 13 then
	    ...
	    UI:WaitShowDialogue(STRINGS:Format(STRINGS.MapStrings['Emolga_3']))
	...
	if SV.lot_emolga.talkshrine == false then
	  if hid > 0 and hid < 3 then
	    UI:SetSpeaker(chara)
	    UI:WaitShowDialogue(STRINGS:Format(STRINGS.MapStrings['Emolga_4']))
	    if hid == 2 then
		  if SV.global_quest.StoryProgression < 13 then
	        UI:SetSpeaker(powwene)
			...
			UI:SetSpeaker(chara)
			UI:SetSpeakerEmotion("Surprised")
		    UI:WaitShowDialogue(STRINGS:Format(STRINGS.MapStrings['Emolga_6']))
		    UI:SetSpeaker(powwene)
			UI:WaitShowDialogue(STRINGS:Format(STRINGS.MapStrings['Powwene_3']))
			UI:SetSpeaker(chara)
			UI:SetSpeakerEmotion("Crying")
		    UI:WaitShowDialogue(STRINGS:Format(STRINGS.MapStrings['Emolga_7']))
		    UI:SetSpeaker(powwene)
			UI:WaitShowDialogue(STRINGS:Format(STRINGS.MapStrings['Powwene_4'], SV.playername))
		  else
		    UI:SetSpeaker(chara)
			UI:SetSpeakerEmotion("Surprised")
			UI:WaitShowDialogue(STRINGS:Format(STRINGS.MapStrings['Emolga_6']))
			UI:SetSpeakerEmotion("Crying")
			UI:WaitShowDialogue(STRINGS:Format(STRINGS.MapStrings['Emolga_7_B']))
		  end
		  ...
		  UI:SetSpeaker(chara)
		  UI:WaitShowDialogue(STRINGS:Format(STRINGS.MapStrings['Emolga_5']))
	    end
	  end
	else
	  UI:SetSpeaker(chara)
	  UI:SetSpeakerEmotion("Sad")
	  UI:WaitShowDialogue(STRINGS:Format(STRINGS.MapStrings['Emolga_8']))
	end
  else
    UI:SetSpeaker(chara)
	UI:SetSpeakerEmotion("Happy")
    UI:WaitShowDialogue(STRINGS:Format(STRINGS.MapStrings['Emolga_0']))
