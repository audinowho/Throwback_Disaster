...
function watertomb_bossroom.Enter(map)
  ...
  if SV.global_quest.StoryProgression == 16 then
	...
	UI:WaitShowDialogue(STRINGS:Format(STRINGS.MapStrings['Gyarados_5']))
	COMMONEX.SmoothRemove("Gyarados")
	UI:SetSpeaker(smoochum)
	UI:SetSpeakerEmotion("Dizzy")
	UI:WaitShowDialogue(STRINGS:Format(STRINGS.MapStrings['Smoochun_0']))
	UI:SetSpeaker(powwene)
	UI:WaitShowDialogue(STRINGS:Format(STRINGS.MapStrings['Powwene_4']))
	UI:SetSpeaker(smoochum)
	UI:SetSpeakerEmotion("Surprised")
	UI:WaitShowDialogue(STRINGS:Format(STRINGS.MapStrings['Smoochun_1']))
	UI:SetSpeaker(powwene)
...
function watertomb_bossroom.Speak_Touch(obj, activator)
  ...
  if SV.global_quest.StoryProgression == 14 then
	...
	GROUND:MoveInDirection(powwene, Direction.Up, 24, false, 1)
	UI:SetSpeaker(boss)
	UI:WaitShowDialogue(STRINGS:Format(STRINGS.MapStrings['Gyarados_0']))
	UI:SetSpeaker(powwene)
	UI:SetSpeakerEmotion("Stunned")
	...
	UI:SetSpeaker(boss)
	UI:WaitShowDialogue(STRINGS:Format(STRINGS.MapStrings['Gyarados_1']))
	UI:WaitShowDialogue(STRINGS:Format(STRINGS.MapStrings['Gyarados_2']))
	UI:SetSpeaker(powwene)
	UI:WaitShowDialogue(STRINGS:Format(STRINGS.MapStrings['Powwene_2']))
	UI:SetSpeaker(boss)
	UI:SetSpeakerEmotion("Determined")
	UI:WaitShowDialogue(STRINGS:Format(STRINGS.MapStrings['Gyarados_3']))
	UI:SetSpeaker(powwene)
	UI:SetSpeakerEmotion("Sad")
	UI:WaitShowDialogue(STRINGS:Format(STRINGS.MapStrings['Powwene_3']))
	UI:SetSpeaker(boss)
	UI:SetSpeakerEmotion("Angry")
	UI:WaitShowDialogue(STRINGS:Format(STRINGS.MapStrings['Gyarados_4']))
